      ...
      >
        ...
        <div className="px-6 py-5 space-y-4">
          <p className="text-sm" style={{ color: 'var(--tp-text-2)' }}>
            Se eliminarán permanentemente todas las tareas, notas, recordatorios e historial de este
            proyecto.
          </p>

          <div>
            <p className="text-xs font-semibold mb-1.5" style={{ color: 'var(--tp-text-2)' }}>
              Escribe <span style={{ color: 'var(--tp-text)' }}>{project.name}</span> para confirmar
            </p>
            <input
              value={confirmText}
